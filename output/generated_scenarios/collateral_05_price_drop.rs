//! Scenario: collateral_05_price_drop
//! 
...
#[instrument(
    name = "sim_bootstrap.collateral_05_price_drop_scenario",
    skip(app, clock, clock_ctrl),
    err
)]
pub async fn collateral_05_price_drop_scenario(
    sub: Subject,
    app: &LanaApp,
    clock: &ClockHandle,
    clock_ctrl: &ClockController,
) -> anyhow::Result<()> {
    event!(tracing::Level::INFO, "Starting collateral_05_price_drop scenario");
    ...
    event!(tracing::Level::INFO, "Completed collateral_05_price_drop scenario");
    Ok(())
}