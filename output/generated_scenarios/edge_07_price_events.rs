...
#[instrument(
    name = "sim_bootstrap.edge_07_price_events_scenario",
    skip(app, clock, clock_ctrl),
    err
)]
pub async fn edge_07_price_events_scenario(
    sub: Subject,
    app: &LanaApp,
    clock: &ClockHandle,
    clock_ctrl: &ClockController,
) -> anyhow::Result<()> {
    event!(tracing::Level::INFO, "Starting edge_07_price_events scenario");
    ...
    event!(tracing::Level::INFO, "Completed edge_07_price_events scenario");
    Ok(())
}