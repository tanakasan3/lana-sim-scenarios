...
#[instrument(
    name = "sim_bootstrap.payment_01_on_time_scenario",
    skip(app, clock, clock_ctrl),
    err
)]
pub async fn payment_01_on_time_scenario(
    sub: Subject,
    app: &LanaApp,
    clock: &ClockHandle,
    clock_ctrl: &ClockController,
) -> anyhow::Result<()> {
    event!(tracing::Level::INFO, "Starting payment_01_on_time scenario");
    ...
    event!(tracing::Level::INFO, "Completed payment_01_on_time scenario");
    Ok(())
}