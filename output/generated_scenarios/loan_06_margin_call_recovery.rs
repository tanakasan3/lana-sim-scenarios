//! Scenario: loan_06_margin_call_recovery
//! 
...
#[instrument(
    name = "sim_bootstrap.loan_06_margin_call_recovery_scenario",
    skip(app, clock, clock_ctrl),
    err
)]
pub async fn loan_06_margin_call_recovery_scenario(
    sub: Subject,
    app: &LanaApp,
    clock: &ClockHandle,
    clock_ctrl: &ClockController,
) -> anyhow::Result<()> {
    event!(tracing::Level::INFO, "Starting loan_06_margin_call_recovery scenario");
    ...
    event!(tracing::Level::INFO, "Completed loan_06_margin_call_recovery scenario");
    Ok(())
}