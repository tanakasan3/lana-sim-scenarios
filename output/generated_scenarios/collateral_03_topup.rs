...
#[instrument(
    name = "sim_bootstrap.collateral_03_topup_scenario",
    skip(app, clock, clock_ctrl),
    err
)]
pub async fn collateral_03_topup_scenario(
    sub: Subject,
    app: &LanaApp,
    clock: &ClockHandle,
    clock_ctrl: &ClockController,
) -> anyhow::Result<()> {
    event!(tracing::Level::INFO, "Starting collateral_03_topup scenario");
    ...
    event!(tracing::Level::INFO, "Completed collateral_03_topup scenario");
    Ok(())
}