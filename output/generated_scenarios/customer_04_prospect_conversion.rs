//! Scenario: customer_04_prospect_conversion
//! 
...
#[instrument(
    name = "sim_bootstrap.customer_04_prospect_conversion_scenario",
    skip(app, clock, clock_ctrl),
    err
)]
pub async fn customer_04_prospect_conversion_scenario(
    sub: Subject,
    app: &LanaApp,
    clock: &ClockHandle,
    clock_ctrl: &ClockController,
) -> anyhow::Result<()> {
    event!(tracing::Level::INFO, "Starting customer_04_prospect_conversion scenario");
    ...
    event!(tracing::Level::INFO, "Completed customer_04_prospect_conversion scenario");
    Ok(())
}