//! Scenario: collateral_04_withdrawal
//! 
...
#[instrument(
    name = "sim_bootstrap.collateral_04_withdrawal_scenario",
    skip(app, clock, clock_ctrl),
    err
)]
pub async fn collateral_04_withdrawal_scenario(
    sub: Subject,
    app: &LanaApp,
    clock: &ClockHandle,
    clock_ctrl: &ClockController,
) -> anyhow::Result<()> {
    event!(tracing::Level::INFO, "Starting collateral_04_withdrawal scenario");
    ...
    event!(tracing::Level::INFO, "Completed collateral_04_withdrawal scenario");
    Ok(())
}