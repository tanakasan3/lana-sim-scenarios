...
#[instrument(
    name = "sim_bootstrap.deposit_01_success_scenario",
    skip(app, clock, clock_ctrl),
    err
)]
pub async fn deposit_01_success_scenario(
    sub: Subject,
    app: &LanaApp,
    clock: &ClockHandle,
    clock_ctrl: &ClockController,
) -> anyhow::Result<()> {
    event!(tracing::Level::INFO, "Starting deposit_01_success scenario");
    ...
    event!(tracing::Level::INFO, "Completed deposit_01_success scenario");
    Ok(())
}