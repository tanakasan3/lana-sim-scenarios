//! Scenario: loan_11_full_liquidation
//! 
...
#[instrument(
    name = "sim_bootstrap.loan_11_full_liquidation_scenario",
    skip(app, clock, clock_ctrl),
    err
)]
pub async fn loan_11_full_liquidation_scenario(
    sub: Subject,
    app: &LanaApp,
    clock: &ClockHandle,
    clock_ctrl: &ClockController,
) -> anyhow::Result<()> {
    event!(tracing::Level::INFO, "Starting loan_11_full_liquidation scenario");
    ...
    let cf_terms = helpers::std_terms();  // TODO: customize terms from {'annual_rate': '0.15', 'duration': {'Months': 6}, 'interest_due_duration_from_accrual': {'Days': 15}, 'accrual_cycle_interval': 'EndOfMonth', 'accrual_interval': 'EndOfDay', 'one_time_fee_rate': '0.02', 'liquidation_cvl': {'Finite': '1.05'}, 'margin_call_cvl': {'Finite': '1.10'}, 'initial_cvl': {'Finite': '1.25'}, 'disbursal_policy': 'SingleDisbursal'}
    ...
    // TODO: CollateralEvent::LiquidationProceedsReceived

    // TODO: CollateralEvent::LiquidationCompleted

    event!(tracing::Level::INFO, "Completed loan_11_full_liquidation scenario");
    Ok(())
}