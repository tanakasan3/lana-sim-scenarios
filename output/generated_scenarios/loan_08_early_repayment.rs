//! Scenario: loan_08_early_repayment
//! 
...
#[instrument(
    name = "sim_bootstrap.loan_08_early_repayment_scenario",
    skip(app, clock, clock_ctrl),
    err
)]
pub async fn loan_08_early_repayment_scenario(
    sub: Subject,
    app: &LanaApp,
    clock: &ClockHandle,
    clock_ctrl: &ClockController,
) -> anyhow::Result<()> {
    event!(tracing::Level::INFO, "Starting loan_08_early_repayment scenario");
    ...
    event!(tracing::Level::INFO, "Completed loan_08_early_repayment scenario");
    Ok(())
}