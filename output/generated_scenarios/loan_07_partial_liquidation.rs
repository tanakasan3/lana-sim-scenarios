...
pub async fn loan_07_partial_liquidation_scenario(
    ...
    let cf_terms = helpers::std_terms();  // TODO: customize terms from {'annual_rate': '0.12', 'duration': {'Months': 12}, 'interest_due_duration_from_accrual': {'Days': 30}, 'accrual_cycle_interval': 'EndOfMonth', 'accrual_interval': 'EndOfDay', 'one_time_fee_rate': '0.01', 'liquidation_cvl': {'Finite': '1.05'}, 'margin_call_cvl': {'Finite': '1.15'}, 'initial_cvl': {'Finite': '1.25'}, 'disbursal_policy': 'SingleDisbursal'}
