//! Scenario: loan_03_disbursal_denied
//! 
...
#[instrument(
    name = "sim_bootstrap.loan_03_disbursal_denied_scenario",
    skip(app, clock, clock_ctrl),
    err
)]
pub async fn loan_03_disbursal_denied_scenario(
    sub: Subject,
    app: &LanaApp,
    clock: &ClockHandle,
    clock_ctrl: &ClockController,
) -> anyhow::Result<()> {
    event!(tracing::Level::INFO, "Starting loan_03_disbursal_denied scenario");
    ...
    event!(tracing::Level::INFO, "Completed loan_03_disbursal_denied scenario");
    Ok(())
}