...
#[instrument(
    name = "sim_bootstrap.loan_04_late_payment_scenario",
    skip(app, clock, clock_ctrl),
    err
)]
pub async fn loan_04_late_payment_scenario(
    sub: Subject,
    app: &LanaApp,
    clock: &ClockHandle,
    clock_ctrl: &ClockController,
) -> anyhow::Result<()> {
    event!(tracing::Level::INFO, "Starting loan_04_late_payment scenario");
    ...
    let cf_terms = helpers::std_terms();  // TODO: customize terms from {'annual_rate': '0.10', 'duration': {'Months': 6}, 'interest_due_duration_from_accrual': {'Days': 15}, 'obligation_overdue_duration_from_due': {'Days': 15}, 'accrual_cycle_interval': 'EndOfMonth', 'accrual_interval': 'EndOfDay', 'one_time_fee_rate': '0.01', 'liquidation_cvl': {'Finite': '1.10'}, 'margin_call_cvl': {'Finite': '1.25'}, 'initial_cvl': {'Finite': '1.40'}, 'disbursal_policy': 'SingleDisbursal'}
    ...
    event!(tracing::Level::INFO, "Completed loan_04_late_payment scenario");
    Ok(())
}