...
#[instrument(
    name = "sim_bootstrap.edge_04_max_ltv_scenario",
    skip(app, clock, clock_ctrl),
    err
)]
pub async fn edge_04_max_ltv_scenario(
    sub: Subject,
    app: &LanaApp,
    clock: &ClockHandle,
    clock_ctrl: &ClockController,
) -> anyhow::Result<()> {
    event!(tracing::Level::INFO, "Starting edge_04_max_ltv scenario");
    ...
    event!(tracing::Level::INFO, "Completed edge_04_max_ltv scenario");
    Ok(())
}