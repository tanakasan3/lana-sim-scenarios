//! Scenario: collateral_06_price_recovery
//! 
...
#[instrument(
    name = "sim_bootstrap.collateral_06_price_recovery_scenario",
    skip(app, clock, clock_ctrl),
    err
)]
pub async fn collateral_06_price_recovery_scenario(
    sub: Subject,
    app: &LanaApp,
    clock: &ClockHandle,
    clock_ctrl: &ClockController,
) -> anyhow::Result<()> {
    event!(tracing::Level::INFO, "Starting collateral_06_price_recovery scenario");
    ...
    event!(tracing::Level::INFO, "Completed collateral_06_price_recovery scenario");
    Ok(())
}