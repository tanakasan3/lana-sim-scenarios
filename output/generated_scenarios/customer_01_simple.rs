...
#[instrument(
    name = "sim_bootstrap.customer_01_simple_scenario",
    skip(app, clock, clock_ctrl),
    err
)]
pub async fn customer_01_simple_scenario(
    sub: Subject,
    app: &LanaApp,
    clock: &ClockHandle,
    clock_ctrl: &ClockController,
) -> anyhow::Result<()> {
    event!(tracing::Level::INFO, "Starting customer_01_simple scenario");
    ...
    event!(tracing::Level::INFO, "Completed customer_01_simple scenario");
    Ok(())
}